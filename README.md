...
- Implémentation d'instance dockers et separer l'ensemble des outils en micro services.
- Implementation d'une base de donnée MySQL, PostGre ou autres en remplacement de la base de donnée textuelle.
- Ajout d'un outils pour la gestion des horaires du personnel
- Dessiner de vrais graphiques sur le module de stats, me semble un peu compliqué a réaliser mais faisable.

Note Importante 2 : Le logo du logiciel à été faite par IA (ChatGPT 5.4)